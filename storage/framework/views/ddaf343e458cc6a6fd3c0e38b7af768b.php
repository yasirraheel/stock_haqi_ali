        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="<?php echo e(route('admin.audio.update', $audio->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="title" name="title" value="<?php echo e(old('title', $audio->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                              id="description" name="description" rows="4"><?php echo e(old('description', $audio->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file <?php $__errorArgs = ['audio_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                            ...
                                            <div class="card mt-2">
                                                <div class="card-body">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="audio-info">
                                                                <h6 class="mb-1"><?php echo e($audio->title); ?></h6>
                                                        ...
                                                        <div class="col-md-2 text-right">
                                                            <a href="<?php echo e(asset('storage/' . $audio->audio_path)); ?>" target="_blank" class="btn btn-sm btn-info" title="Download">
                                                    ...
                                                    <audio id="current_audio_player" preload="metadata" style="display: none;">
                                                        ...
                                                        <source src="<?php echo e(asset('storage/' . $audio->audio_path)); ?>" type="audio/wav">
                                                        <source src="<?php echo e(asset('storage/' . $audio->audio_path)); ?>" type="audio/ogg">
                                                        <source src="<?php echo e(asset('storage/' . $audio->audio_path)); ?>" type="audio/mp4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control <?php $__errorArgs = ['license_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               id="license_price" name="license_price" value="<?php echo e(old('license_price', $audio->license_price)); ?>"
                                               step="0.01" min="0" pattern="[0-9]+([.][0-9]{1,2})?">
                                    </div>
                                    <small class="form-text text-muted">Leave empty for free audio</small>
                                    <?php $__errorArgs = ['license_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="duration" name="duration" value="<?php echo e(old('duration', $audio->duration)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['file_size'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                           id="file_size" name="file_size" value="<?php echo e(old('file_size', $audio->file_size)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?php $__errorArgs = ['format'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="format" name="format">
                                        ...
                                        <option value="MP3" <?php echo e(old('format', $audio->format) == 'MP3' ? 'selected' : ''); ?>>MP3</option>
                                        <option value="WAV" <?php echo e(old('format', $audio->format) == 'WAV' ? 'selected' : ''); ?>>WAV</option>
                                        <option value="OGG" <?php echo e(old('format', $audio->format) == 'OGG' ? 'selected' : ''); ?>>OGG</option>
                                        <option value="AAC" <?php echo e(old('format', $audio->format) == 'AAC' ? 'selected' : ''); ?>>AAC</option>
                                        <option value="FLAC" <?php echo e(old('format', $audio->format) == 'FLAC' ? 'selected' : ''); ?>>FLAC</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control <?php $__errorArgs = ['bitrate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                           id="bitrate" name="bitrate" value="<?php echo e(old('bitrate', $audio->bitrate)); ?>" min="0">
                                    <?php $__errorArgs = ['bitrate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control <?php $__errorArgs = ['sample_rate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                           id="sample_rate" name="sample_rate" value="<?php echo e(old('sample_rate', $audio->sample_rate)); ?>" min="0">
                                    <?php $__errorArgs = ['sample_rate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="genre" name="genre" value="<?php echo e(old('genre', $audio->genre)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['mood'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                           id="mood" name="mood" value="<?php echo e(old('mood', $audio->mood)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                           id="tags" name="tags" value="<?php echo e(old('tags', $audio->tags)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active"
                                               value="1" <?php echo e(old('is_active', $audio->is_active) ? 'checked' : ''); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('admin.audio.index')); ?>" class="btn btn-secondary">
...
function extractAudioMetadata(file) {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.audio.metadata")); ?>',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stock_new\resources\views/admin/audio/edit.blade.php ENDPATH**/ ?>