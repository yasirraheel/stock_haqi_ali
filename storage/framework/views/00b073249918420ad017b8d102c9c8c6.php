...
<tbody>
<tr>
<td><a href="<?php echo e(url('/')); ?>" target="_blank"><img style="border:0;display:block;outline:none;text-decoration:none;height:auto;min-width: 20%;width: 20%;max-width: 100%;font-size: 13px;margin: 0 auto;padding: 25px;" src="<?php echo e(URL::asset('/'.getcong('site_logo'))); ?>" width="200" height="25" style="width:200px;height:25px"></a></td> 
</tr>
</tbody>
</table>
</td>
...
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828">Your Subscription on <?php echo e(getcong('site_name')); ?> has created. You can start watching great videos on our platform..
<br/>
        <br/> 
...
<a href="<?php echo e(\URL::to('login/')); ?>" style="font-size: 15px;margin-bottom:10px;text-align: center;background: #343565;color: #fff;border-radius: 6px;text-decoration:none;padding:10px 30px;">Login</a>
...
<a href="<?php echo e(stripslashes(getcong('footer_fb_link'))); ?>" target="_blank" style="color:#1e2026">Facebook</a> | 
<a href="<?php echo e(stripslashes(getcong('footer_instagram_link'))); ?>" target="_blank" style="color:#1e2026">Instagram</a> | 
<a href="<?php echo e(stripslashes(getcong('footer_twitter_link'))); ?>" target="_blank" style="color:#1e2026">Twitter</a>  
</td>
</tr>
</tbody>
</table>
...
</html><?php /**PATH C:\xampp\htdocs\stock_new\resources\views/emails/subscription_created.blade.php ENDPATH**/ ?>