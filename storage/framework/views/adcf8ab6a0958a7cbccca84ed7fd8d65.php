...
<header>
                ...
                <div class="main-nav leftnav">
                  ...
                  <div id="menu" class="collapse header-menu">
                    <ul class="nav vfx-item-nav">
                      ...
                      <?php if(getcong('menu_photos')): ?>
                      <li><a href="<?php echo e(URL::to('photos/')); ?>" class="<?php echo e(classActivePathSite('photos')); ?>" title="Photos">Photos</a></li>
                      <?php endif; ?>

                      <?php if(getcong('menu_audio')): ?>
                      <li><a href="<?php echo e(URL::to('audio/')); ?>" class="<?php echo e(classActivePathSite('audio')); ?>" title="Audio">Audio</a></li>
                      <?php endif; ?>
  ...
  <!-- End Header -->
<?php /**PATH C:\xampp\htdocs\stock_new\resources\views/_particles/header.blade.php ENDPATH**/ ?>