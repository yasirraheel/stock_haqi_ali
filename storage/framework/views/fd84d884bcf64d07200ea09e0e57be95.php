            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="m-t-0 header-title">Add New Audio</h4>
                            </div>
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>"
                                           id="audio_file" name="audio_file" accept="audio/*" required onchange="handleAudioUpload(this)">
...
unset($__errorArgs, $__bag); ?>"
                                               id="license_price" name="license_price" value="<?php echo e(old('license_price')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                           id="file_size" name="file_size" value="<?php echo e(old('file_size')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="format" name="format">
                                        ...
                                        <option value="MP3" <?php echo e(old('format') == 'MP3' ? 'selected' : ''); ?>>MP3</option>
                                        <option value="WAV" <?php echo e(old('format') == 'WAV' ? 'selected' : ''); ?>>WAV</option>
                                        <option value="OGG" <?php echo e(old('format') == 'OGG' ? 'selected' : ''); ?>>OGG</option>
                                        <option value="AAC" <?php echo e(old('format') == 'AAC' ? 'selected' : ''); ?>>AAC</option>
                                        <option value="FLAC" <?php echo e(old('format') == 'FLAC' ? 'selected' : ''); ?>>FLAC</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                           id="bitrate" name="bitrate" value="<?php echo e(old('bitrate')); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>"
                                           id="sample_rate" name="sample_rate" value="<?php echo e(old('sample_rate')); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>"
                                           id="genre" name="genre" value="<?php echo e(old('genre')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                           id="mood" name="mood" value="<?php echo e(old('mood')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Create Audio
                            </button>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stock_new\resources\views/admin/audio/create.blade.php ENDPATH**/ ?>