...
<video id="videoPlayer" controls autoplay preload="metadata" 
    poster="<?php echo e(url($movies_info->video_image_thumb)); ?>" 
    ...
    <div
        ...
        <div class="row justify-content-center align-items-center mb-3">
            <div class="col-12">
                <?php if(isset($movies_info->video_slug) && isset($movies_info->id) && isset($movies_info->video_title)): ?>
                    <a
                        href="<?php echo e(url('movies/details', ['slug' => $movies_info->video_slug, 'id' => $movies_info->id])); ?>">
                        <p><?php echo e($movies_info->video_title); ?></p>
                    </a>
                <?php else: ?>
                    <p><?php echo e('Movie details are not available'); ?></p>
                <?php endif; ?>
            </div>
 <?php
            ...
            <div class="col-12 text-right">
                <?php if(auth()->guard()->check()): ?>
                    <form
                        action="<?php echo e($user_has_liked ? route('movie-videos.unlike', $movies_info->id) : route('movie-videos.like', $movies_info->id)); ?>"
                        method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="btn <?php echo e($user_has_liked ? 'btn-success' : 'btn-primary'); ?> btn-custom">
                            <i class="fas fa-heart"></i>
                            <span class="like-text"><?php echo e($user_has_liked ? 'Unlike' : 'Like'); ?>

                                (<?php echo e($movies_info->likes ?? 0); ?>)
                            </span>
                        </button>
                    </form>

                    <?php if(isset($movies_info->video_url)): ?>
                     <?php if($license): ?>
                        <a href="<?php echo e($movies_info->video_url); ?>" target="_blank" class="btn btn-primary btn-custom">
                ...
                <?php if(isset($movies_info->webpage_url)): ?>
                    <a href="<?php echo e($movies_info->webpage_url); ?>" target="_blank" class="btn btn-primary btn-custom">
                    ...
                    <?php if(isset($movies_info->id)): ?>
                        <?php if($license): ?>
                            <a href="<?php echo e(route('download.license', ['license_key' => $license->license_key])); ?>"
                                ...
                                License</a>
                        <?php else: ?>
                            <?php if(Auth::user()->id == $movies_info->added_by): ?>
                                <a href="#" class="vfx-item-btn-danger text-uppercase mb-30" title="edit movie">Added
                                    By You</a>
                            <?php else: ?>
                                <a href="<?php echo e(URL::to('payment_method/' . $movies_info->id)); ?>"
                                    class="vfx-item-btn-danger text-uppercase mb-30" title="buy license">Buy License
                                    (<?php echo e($movies_info->license_price); ?><?php echo e($currency_code); ?>)</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
...
<?php /**PATH /home/u273790872/domains/cineworm.org/public_html/stock/resources/views/pages/movies/player/google_drive_player.blade.php ENDPATH**/ ?>