<div class="topbar">
      <div class="topbar-left"> 
        <a href="<?php echo e(URL::to('admin/dashboard')); ?>" class="logo">
          <span>
            ...
            <img src="<?php echo e(URL::asset('/'.getcong('site_logo'))); ?>" alt="Site Logo" width="120">
            <?php else: ?>
            <img src="<?php echo e(URL::asset('site_assets/images/logo.png')); ?>" alt="Site Logo" width="120">           
            <?php endif; ?>
          </span>
            ...
            <ul class="list-unstyled topbar-right-menu float-right mb-0">
              ...
              <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                  <a href="<?php echo e(URL::to('/profile')); ?>" class="dropdown-item notify-item">
    ...
    </div><?php /**PATH /home/u273790872/domains/cineworm.org/public_html/stock/resources/views/admin/topbar.blade.php ENDPATH**/ ?>