...
<head>
  ...
  <?php if(getcong('site_favicon')): ?>
  <link rel="shortcut icon" href="<?php echo e(URL::asset('/'.getcong('site_favicon'))); ?>">
  <?php else: ?>
  ...
  <div class="wrapper-page">
    <div class="text-center">
      ...
      <?php if(getcong('site_logo')): ?>
        <a class="navbar-brand" href="<?php echo e(URL::to('/')); ?>" target="_blank"> <img src="<?php echo e(URL::asset('/'.getcong('site_logo'))); ?>" alt="Site Logo" width="150"> </a> 
      <?php else: ?>
        <a class="navbar-brand" href="<?php echo e(URL::to('/')); ?>" target="_blank"> <img src="<?php echo e(URL::asset('site_assets/images/logo.png')); ?>" alt="Site Logo"> </a>          
      <?php endif; ?>
...
</html><?php /**PATH /home/u273790872/domains/cineworm.org/public_html/stock/resources/views/admin/index.blade.php ENDPATH**/ ?>