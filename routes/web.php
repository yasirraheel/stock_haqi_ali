...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    // Route::get('user/movies/add_movie', 'MoviesController@addMovieByUser');
    ...
    Route::post('effects/cleanup-invalid', 'EffectsController@cleanupInvalid')->name('admin.effects.cleanup-invalid');
    ...
    Route::resource('photo-categories', 'PhotoCategoryController')->only(['index', 'store', 'destroy'])->names([
        ...
        'store' => 'admin.photo-categories.store',
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('/getYoutubeVideoUrl', 'IndexController@getYoutubeVideoUrl');
        ...
        Route::get('email', 'EmailManagementController@showEmail');
        ...
        Route::get('generateScreenshot', function () {
            $page_title='Generate Screenshot';
            $thumnails = \App\Models\Thumbnail::paginate(10);
            return view('admin.generate_screenshot',compact('page_title','thumnails') ); // Replace 'your_view_name' with the actual name of your view
        });

        Route::post('generateScreenshot', 'SettingsController@store_generateScreenshot');

        // Route::get('generateScreenshot/{file_id}', 'SettingsController@store_generateScreenshot');

        Route::get('paypal_payout', 'SettingsController@paypal_payout');
        Route::get('sold_licenses', 'SettingsController@sold_licenses');
        Route::get('paypal_dashboard', 'SettingsController@paypal_dashboard');

        Route::get('google_drive_api', 'SettingsController@google_drive_api');
        Route::post('google_drive_api', 'SettingsController@google_drive_api_store');
        Route::get('google_drive_api/delete/{id}', 'SettingsController@google_drive_api_delete');
        ...
        Route::get('/clear-cache', function () {
            ...
            Session::flash('flash_message', 'Command run successfully');
...
Route::post('login', 'IndexController@postLogin');
Route::get('admin/sold_licenses', 'Admin\SettingsController@sold_licenses');
...
Route::get('payment_method/{video_id}', 'UserController@payment_method');
Route::get('/download-license/{license_key}', [UserController::class, 'downloadLicense'])->name('download.license');
...
Route::post('paypal/pay_out', 'PaypalController@paypal_payout');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('movie-videos/{video_id}/like', 'MoviesController@like')->name('movie-videos.like');
    Route::post('movie-videos/{video_id}/unlike', 'MoviesController@unlike')->name('movie-videos.unlike');
});
