                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('license_price') is-invalid @enderror"
                                               id="license_price" name="license_price" value="{{ old('license_price') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('format') is-invalid @enderror" id="format" name="format">
                                        ...
                                        <option value="MP3" {{ old('format') == 'MP3' ? 'selected' : '' }}>MP3</option>
                                        <option value="WAV" {{ old('format') == 'WAV' ? 'selected' : '' }}>WAV</option>
                                        <option value="OGG" {{ old('format') == 'OGG' ? 'selected' : '' }}>OGG</option>
                                        <option value="AAC" {{ old('format') == 'AAC' ? 'selected' : '' }}>AAC</option>
                                        <option value="FLAC" {{ old('format') == 'FLAC' ? 'selected' : '' }}>FLAC</option>
                                    </select>
                                    @error('format')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('bitrate') is-invalid @enderror"
                                           id="bitrate" name="bitrate" value="{{ old('bitrate') }}" min="0">
                                    @error('bitrate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('sample_rate') is-invalid @enderror"
                                           id="sample_rate" name="sample_rate" value="{{ old('sample_rate') }}" min="0">
                                    @error('sample_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('mood') is-invalid @enderror"
                                           id="mood" name="mood" value="{{ old('mood') }}"
