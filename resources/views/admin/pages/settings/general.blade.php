                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="site_name"
                                                value="{{ isset($settings->site_name) ? stripslashes($settings->site_name) : null }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="site_logo" id="site_logo"
                                                    value="{{ isset($settings->site_logo) ? $settings->site_logo : null }}"
                                    ...
                                    @if (isset($settings->site_logo))
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <img src="{{ URL::to('/' . $settings->site_logo) }}" alt="video image"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="site_favicon" id="site_favicon"
                                                    value="{{ isset($settings->site_favicon) ? $settings->site_favicon : null }}"
                                                    class="form-control" readonly>
                                                <div class="input-group-append">
                                                    <button type="button"
                                                        class="btn btn-dark waves-effect waves-light popup_selector"
                                    ...
                                    @if (isset($settings->site_favicon))
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">&nbsp;</label>
                                            <div class="col-sm-8">
                                                <img src="{{ URL::to('/' . $settings->site_favicon) }}" alt="video image"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="site_email"
                                                value="{{ isset($settings->site_email) ? $settings->site_email : null }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-3 col-form-label">{{ trans('words.site_copyright_text') }}</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-3 col-form-label">{{ trans('words.default_timezone') }}</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-3 col-form-label">{{ trans('words.default_language') }}</label>
                                        <div class="col-sm-8">
                                            <select class="form-control select2" name="default_language">

                                                <option value="en" @if ($settings->default_language == 'en') selected @endif>
                                                    English</option>
                                                <option value="es" @if ($settings->default_language == 'es') selected @endif>
                                                    Spanish</option>
                                                <option value="fr" @if ($settings->default_language == 'fr') selected @endif>
                                                    French</option>
                                                <option value="pt" @if ($settings->default_language == 'pt') selected @endif>
                                                    Portuguese</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="styling">
                                                ...
                                                <option value="style-one"
                                                    @if ($settings->styling == 'style-one') selected @endif>Style 1</option>
                                                <option value="style-two"
                                                    @if ($settings->styling == 'style-two') selected @endif>Style 2</option>
                                                <option value="style-three"
                                                    @if ($settings->styling == 'style-three') selected @endif>Style 3</option>
                                                <option value="style-four"
                                                    @if ($settings->styling == 'style-four') selected @endif>Style 4</option>
                                                <option value="style-five"
                                                    @if ($settings->styling == 'style-five') selected @endif>Style 5</option>
                                                <option value="style-six"
                                                    @if ($settings->styling == 'style-six') selected @endif>Style 6</option>

                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">{{ trans('words.currency_code') }}*
                                        </label>
                                        <div class="col-sm-8">
                                            <select name="currency_code" id="currency_code" class="form-control select2">
                                                @foreach (getCurrencyList() as $index => $currency_list)
                                                    <option value="{{ $index }}"
                                                        @if ($settings->currency_code == $index) selected @endif>
                                                        {{ $index }} - {{ $currency_list }}</option>
                                                @endforeach
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="footer_fb_link"
                                                value="{{ isset($settings->footer_fb_link) ? stripslashes($settings->footer_fb_link) : null }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="footer_twitter_link"
                                                value="{{ isset($settings->footer_twitter_link) ? stripslashes($settings->footer_twitter_link) : null }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="footer_instagram_link"
                                                value="{{ isset($settings->footer_instagram_link) ? stripslashes($settings->footer_instagram_link) : null }}"
                                                class="form-control">
                                        </div>
                                    </div>

                                    <hr />
                                    <h4 class="m-t-0 header-title">{{ trans('words.apps_text') }} <small id="emailHelp"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="footer_google_play_link"
                                                value="{{ isset($settings->footer_google_play_link) ? stripslashes($settings->footer_google_play_link) : null }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="footer_apple_store_link"
                                                value="{{ isset($settings->footer_apple_store_link) ? stripslashes($settings->footer_apple_store_link) : null }}"
                                                class="form-control">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="gdpr_cookie_on_off">
                                        ...
                                        <option value="1" @if ($settings->gdpr_cookie_on_off == '1') selected @endif>
                                            {{ trans('words.active') }}</option>
                                        <option value="0" @if ($settings->gdpr_cookie_on_off == '0') selected @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="envato_buyer_name"
                                        value="{{ isset($settings->envato_buyer_name) ? stripslashes($settings->envato_buyer_name) : null }}"
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="envato_purchase_code"
                                        value="{{ isset($settings->envato_purchase_code) ? stripslashes($settings->envato_purchase_code) : null }}"
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="admin_commission"
                                        value="{{ isset($settings->admin_commission) ? stripslashes($settings->admin_commission) : null }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="offset-sm-3 col-sm-9 pl-1">
                                    <button type="submit" class="btn btn-primary waves-effect waves-light">
                                        {{ trans('words.save_settings') }} </button>
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
