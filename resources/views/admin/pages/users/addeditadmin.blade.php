                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="name"
                                        value="{{ isset($user->name) ? $user->name : null }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="email"
                                        value="{{ isset($user->email) ? $user->email : null }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="phone"
                                        value="{{ isset($user->phone) ? $user->phone : null }}" class="form-control">
                                </div>
                            </div>
                            ...
                            @if (isset($user->user_image) and file_exists(public_path('upload/' . $user->user_image)))
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <img src="{{ URL::to('upload/' . $user->user_image) }}" alt="video image"
                            ...
                            <div class="form-group row d-none">
                                <label class="col-sm-3 col-form-label">&nbsp;</label>
                                <div class="col-sm-8">
                                    <p id="sub_admin_id" @if (isset($user->usertype) and $user->usertype != 'Sub_Admin') style="display:none;" @endif>
                                        Permission for Sub Admin<small id="emailHelp"
                                            ...
                                            {{ trans('words.tv_shows_text') }}, {{ trans('words.seasons_text') }},
                                            {{ trans('words.episodes_text') }}, {{ trans('words.sports_cat_text') }},
                                            {{ trans('words.sports_video_text') }}, {{ trans('words.slider') }},
                                            {{ trans('words.home_section') }})</small></p>

                                    <p id="master_admin_id" @if (isset($user->usertype) and $user->usertype != 'Admin') style="display:none;" @endif
                                        @if (!isset($user->id)) style="display:none;" @endif> Permission for
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="status">
                                        <option value="1" @if (isset($user->status) and $user->status == 1) selected @endif>
                                            {{ trans('words.active') }}</option>
                                        <option value="0" @if (isset($user->status) and $user->status == 0) selected @endif>
                                            Ban</option>
                                    </select>
                                </div>
                            </div>
