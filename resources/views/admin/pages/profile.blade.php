        ...
        <div class="col-xl-12">
          <div class="card-box">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="url" name="funding_url" id="funding_url" value="{{ isset(Auth::user()->funding_url) ? Auth::user()->funding_url : null }}" placeholder="Enter your funding URL eg: https://www.paypal.com/yourname" class="form-control">
              </div>
            </div>
            <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="form-group mb-3">
                <label>Funding URL 1</label>
                <input type="url" name="funding_url" id="funding_url" value="{{ isset(Auth::user()->funding_url) ? Auth::user()->funding_url : null }}" placeholder="Enter your funding URL eg: https://www.paypal.com/yourname" class="form-control">
              </div>
            </div> -->
            <div class="form-group row">
