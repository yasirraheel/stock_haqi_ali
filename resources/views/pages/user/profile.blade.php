                    ...
                    <div class="edit-profile-form">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="email" name="paypal_email" id="paypal_email" value="{{ $user->paypal_email }}" placeholder="Enter Correct PayPal Email"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="fileupload_img">
                                        @if (Auth::User()->user_image)
                                            <img class="fileupload_img"
                                                src="{{ URL::asset('upload/' . Auth::User()->user_image) }}"
                                                alt="profile pic" title="profile pic">
                                        @else
                                            <img class="fileupload_img"
                                                src="{{ URL::asset('site_assets/images/user-avatar.png') }}"
                                                alt="profile pic" title="profile pic">
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group d-flex align-items-end flex-column mt-30">
                                <button type="submit"
                                    class="vfx-item-btn-danger text-uppercase">{{ trans('words.update') }}</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
