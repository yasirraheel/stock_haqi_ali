...
class ActionsController extends MainAdminController
{
    ...
    public function ajax_delete(Request $request)
    {
        ...
        else if($action_for=="audio_delete")
        {
            $data_obj = Audio::findOrFail($post_id);

            // Delete the audio file from storage
            if ($data_obj->audio_path && \Storage::disk('public')->exists($data_obj->audio_path)) {
                \Storage::disk('public')->delete($data_obj->audio_path);
            }
