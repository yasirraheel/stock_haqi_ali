...
class UserController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $licenses = UserLicense::where('user_id', $user_id)->paginate(5);
        $soldLicenses = UserLicense::where('author', $user_id)->paginate(5);

        return view('pages.user.dashboard',compact('user','licenses','recently_watched','soldLicenses'));
    }
    ...
    public function editprofile(Request $request)
    {
        ...
        // $user->funding_url = $inputs['funding_url'];
    ...
    public function payment_method($video_id)
    {
        ...
        return view('pages.payment.payment_method',compact('video_info','license_price'));
    }
    ...
    public function downloadLicense($license_key)
    {
        $file_path = storage_path('licenses/' . $license_key . '.txt');

        if (file_exists($file_path)) {
            return response()->download($file_path);
        } else {
            return redirect('/')->with('error', 'License file not found.');
        }
    }
